/**
 * Scene Editor — mock data partagé entre panneaux (hierarchy, assets, patterns,
 * mixer channels, timeline, inspector).
 *
 * Ce fichier sert de "state" côté prototype. Lorsque le backend sera branché,
 * on remplacera ces constantes par un store réel (Zustand, Jotai, etc.).
 */

import type { IconName, TreeNodeData } from "./primitives";
