...
| 2026-05-02 | react-hooks-strict-rules-next16 | 3 règles `react-hooks/{set-state-in-effect,refs,purity}` rétrogradées `error→warn` dans `eslint.config.mjs` | Phase 2 (audit hooks pendant migration App Router) |
